...
public class character1 : MonoBehaviour
{
    ...
    public void Onclick2()   
    {
        ...
        if (C2 == 1)
        {
            ...
            PlayerPrefs.SetInt("character1", 2);
            PlayerPrefs.Save();
    ...
    public void Onclick3()
    {
        ...
        if (C3 == 1)
        {
            ...
            PlayerPrefs.SetInt("character1",3);
            PlayerPrefs.Save();
    ...
    public void Onclick4()
    {
        ...
        if (C4== 1)
        {
            ...
            PlayerPrefs.SetInt("character1",4);
            PlayerPrefs.Save();
    ...
    public void Onclick5()
    {
        ...
        if (C5 == 1)
        {
            ...
            PlayerPrefs.SetInt("character1",5);
            PlayerPrefs.Save();
    ...
    public void Onclick6()
    {
        ...
        if (C6 == 1)
        {
            ...
            PlayerPrefs.SetInt("character1",6);
            PlayerPrefs.Save();
    ...
    public void Onclick7()
    {
        ...
        if (C7 == 1)
        {
            ...
            PlayerPrefs.SetInt("character1",7);
            PlayerPrefs.Save();
    ...
    public void Onclick8()
    {
        ...
        if (C8 == 1)
        {
            ...
            PlayerPrefs.SetInt("character1",8);
            PlayerPrefs.Save();
    ...
    public void Onclick9()
    {
        ...
        if (C9== 1)
        {
            ...
            PlayerPrefs.SetInt("character1",9);
            PlayerPrefs.Save();

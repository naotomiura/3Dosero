...
public class character2 : MonoBehaviour
{
    ...
    public void Onclick4()
    {
        ...
        if (C4== 1)
        {
            ...
            PlayerPrefs.SetInt("character2",4);
            PlayerPrefs.Save();
    ...
    public void Onclick5()
    {
        ...
        if (C5 == 1)
        {
            ...
            PlayerPrefs.SetInt("character2",5);
            PlayerPrefs.Save();
    ...
    public void Onclick6()
    {
        ...
        if (C6 == 1)
        {
            ...
            PlayerPrefs.SetInt("character2",6);
            PlayerPrefs.Save();
    ...
    public void Onclick7()
    {
        ...
        if (C7 == 1)
        {
            ...
            PlayerPrefs.SetInt("character2",7);
            PlayerPrefs.Save();
    ...
    public void Onclick8()
    {
        ...
        if (C8 == 1)
        {
            ...
            PlayerPrefs.SetInt("character2",8);
            PlayerPrefs.Save();
    ...
    public void Onclick9()
    {
        ...
        if (C9== 1)
        {
            ...
            PlayerPrefs.SetInt("character2",9);
            PlayerPrefs.Save();
